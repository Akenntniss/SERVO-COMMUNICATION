...
class SmartRetrySystem {
    ...
    startTimeoutMonitoring() {
        ...
        console.log(`🔍 Surveillance des SIMs défaillantes (vérification toutes les 10 minutes)`);
        ...
        // Surveillance des messages 'failed' toutes les 10 minutes (économe en ressources)
        setInterval(() => {
     ...
     * 
     * OPTIMISÉ: S'exécute toutes les 10 minutes pour économiser les ressources
     */
    async checkFailedMessagesForSimDeactivation() {
        try {
            console.log(`🔍 Surveillance périodique des SIMs défaillantes (toutes les 10 min)...`);
