...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroidx/room/InvalidationTracker;Ljava/util/concurrent/Executor;)V
    ...
    .line 58
    new-instance v1, Landroidx/room/MultiInstanceInvalidationClient$callback$1;

    invoke-direct {v1, p0}, Landroidx/room/MultiInstanceInvalidationClient$callback$1;-><init>(Landroidx/room/MultiInstanceInvalidationClient;)V

    check-cast v1, Landroidx/room/IMultiInstanceInvalidationCallback;

    iput-object v1, p0, Landroidx/room/MultiInstanceInvalidationClient;->callback:Landroidx/room/IMultiInstanceInvalidationCallback;
    ...
    iput-object v1, p0, Landroidx/room/MultiInstanceInvalidationClient;->stopped:Ljava/util/concurrent/atomic/AtomicBoolean;

    .line 66
    new-instance v1, Landroidx/room/MultiInstanceInvalidationClient$serviceConnection$1;

    invoke-direct {v1, p0}, Landroidx/room/MultiInstanceInvalidationClient$serviceConnection$1;-><init>(Landroidx/room/MultiInstanceInvalidationClient;)V

    check-cast v1, Landroid/content/ServiceConnection;

    iput-object v1, p0, Landroidx/room/MultiInstanceInvalidationClient;->serviceConnection:Landroid/content/ServiceConnection;

    .line 79
    new-instance v3, Landroidx/room/MultiInstanceInvalidationClient$$ExternalSyntheticLambda0;

    invoke-direct {v3, p0}, Landroidx/room/MultiInstanceInvalidationClient$$ExternalSyntheticLambda0;-><init>(Landroidx/room/MultiInstanceInvalidationClient;)V

    iput-object v3, p0, Landroidx/room/MultiInstanceInvalidationClient;->setUpRunnable:Ljava/lang/Runnable;

    .line 90
    new-instance v3, Landroidx/room/MultiInstanceInvalidationClient$$ExternalSyntheticLambda1;

    invoke-direct {v3, p0}, Landroidx/room/MultiInstanceInvalidationClient$$ExternalSyntheticLambda1;-><init>(Landroidx/room/MultiInstanceInvalidationClient;)V

    iput-object v3, p0, Landroidx/room/MultiInstanceInvalidationClient;->removeObserverRunnable:Ljava/lang/Runnable;
    ...
    .line 95
    .local v3, "tableNames":Ljava/util/Set;
    move-object v4, v3
    ...
    new-instance v4, Landroidx/room/MultiInstanceInvalidationClient$1;

    invoke-direct {v4, p0, v2}, Landroidx/room/MultiInstanceInvalidationClient$1;-><init>(Landroidx/room/MultiInstanceInvalidationClient;[Ljava/lang/String;)V

    check-cast v4, Landroidx/room/InvalidationTracker$Observer;

    invoke-virtual {p0, v4}, Landroidx/room/MultiInstanceInvalidationClient;->setObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    .line 116
    .end local v3    # "tableNames":Ljava/util/Set;
    nop
