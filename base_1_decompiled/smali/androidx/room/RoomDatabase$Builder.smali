...
.method public build()Landroidx/room/RoomDatabase;
    ...
    .line 1298
    .local v7, "copyFromAssetPathConfig":I
    :goto_5
    iget-object v8, v0, Landroidx/room/RoomDatabase$Builder;->copyFromFile:Ljava/io/File;
    ...
    .line 1300
    .local v11, "copyFromInputStreamConfig":I
    :goto_7
    add-int v12, v7, v9
    ...
    .line 1303
    .local v12, "copyConfigurations":I
    if-ne v12, v2, :cond_f
    ...
    .line 1309
    invoke-direct {v2, v5, v8, v10, v1}, Landroidx/room/SQLiteCopyOpenHelperFactory;-><init>(Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;)V

    .end local v7    # "copyFromAssetPathConfig":I
    .end local v9    # "copyFromFileConfig":I
    .end local v11    # "copyFromInputStreamConfig":I
    .end local v12    # "copyConfigurations":I
    ...
    .restart local v7    # "copyFromAssetPathConfig":I
    .restart local v9    # "copyFromFileConfig":I
    .restart local v11    # "copyFromInputStreamConfig":I
    .restart local v12    # "copyConfigurations":I
    :cond_10
    const/4 v2, 0x0
    ...
    .line 1323
    iget-object v6, v0, Landroidx/room/RoomDatabase$Builder;->queryCallbackExecutor:Ljava/util/concurrent/Executor;
    ...
    .line 1321
    invoke-direct {v5, v1, v6, v4}, Landroidx/room/QueryInterceptorOpenHelperFactory;-><init>(Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;Ljava/util/concurrent/Executor;Landroidx/room/RoomDatabase$QueryCallback;)V
    ...
    invoke-virtual {v2, v6}, Landroidx/room/RoomDatabase$JournalMode;->resolve$room_runtime_release(Landroid/content/Context;)Landroidx/room/RoomDatabase$JournalMode;
