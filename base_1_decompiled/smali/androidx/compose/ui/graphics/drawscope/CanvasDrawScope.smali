...
.method private final configurePaint-46ZPVWY(JLandroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;I)Landroidx/compose/ui/graphics/Paint;
    ...
    .local v1, "$this$configurePaint_46ZPVWY_u24lambda_u2d8":Landroidx/compose/ui/graphics/Paint;
    const/4 v2, 0x0
    ...
    .line 615
    .end local v1    # "$this$configurePaint_46ZPVWY_u24lambda_u2d8":Landroidx/compose/ui/graphics/Paint;
...
.method private final configurePaint-UXdrQoc(Landroidx/compose/ui/graphics/Brush;Landroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;I)Landroidx/compose/ui/graphics/Paint;
    ...
    .local v1, "$this$configurePaint_UXdrQoc_u24lambda_u2d7":Landroidx/compose/ui/graphics/Paint;
    const/4 v2, 0x0
    ...
    .line 594
    .end local v1    # "$this$configurePaint_UXdrQoc_u24lambda_u2d7":Landroidx/compose/ui/graphics/Paint;
...
.method private final configureStrokePaint-ApHOwBQ(Landroidx/compose/ui/graphics/Brush;FFIILandroidx/compose/ui/graphics/PathEffect;FLandroidx/compose/ui/graphics/ColorFilter;I)Landroidx/compose/ui/graphics/Paint;
    ...
    .local v10, "$this$configureStrokePaint_ApHOwBQ_u24lambda_u2d10":Landroidx/compose/ui/graphics/Paint;
    const/4 v11, 0x0

    .line 664
    .local v11, "$i$a$-apply-CanvasDrawScope$configureStrokePaint$2":I
    const/4 v12, 0x1
    ...
    .line 665
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->getSize-NH-jbRc()J

    move-result-wide v14

    invoke-virtual {v0, v14, v15, v10, v6}, Landroidx/compose/ui/graphics/Brush;->applyTo-Pq9zytI(JLandroidx/compose/ui/graphics/Paint;F)V

    goto :goto_1

    .line 666
    :cond_0
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getAlpha()F
    ...
    .line 667
    invoke-interface {v10, v6}, Landroidx/compose/ui/graphics/Paint;->setAlpha(F)V

    .line 669
    :cond_2
    :goto_1
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getColorFilter()Landroidx/compose/ui/graphics/ColorFilter;
    ...
    invoke-interface {v10, v7}, Landroidx/compose/ui/graphics/Paint;->setColorFilter(Landroidx/compose/ui/graphics/ColorFilter;)V

    .line 670
    :cond_3
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getBlendMode-0nO6VwU()I

    move-result v14

    invoke-static {v14, v8}, Landroidx/compose/ui/graphics/BlendMode;->equals-impl0(II)Z

    move-result v14

    if-nez v14, :cond_4

    invoke-interface {v10, v8}, Landroidx/compose/ui/graphics/Paint;->setBlendMode-s9anfk8(I)V

    .line 671
    :cond_4
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getStrokeWidth()F
    ...
    invoke-interface {v10, v1}, Landroidx/compose/ui/graphics/Paint;->setStrokeWidth(F)V

    .line 672
    :cond_6
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getStrokeMiterLimit()F
    ...
    invoke-interface {v10, v2}, Landroidx/compose/ui/graphics/Paint;->setStrokeMiterLimit(F)V

    .line 673
    :cond_8
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getStrokeCap-KaPHkGw()I

    move-result v12

    invoke-static {v12, v3}, Landroidx/compose/ui/graphics/StrokeCap;->equals-impl0(II)Z

    move-result v12

    if-nez v12, :cond_9

    invoke-interface {v10, v3}, Landroidx/compose/ui/graphics/Paint;->setStrokeCap-BeK7IIE(I)V

    .line 674
    :cond_9
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getStrokeJoin-LxFBmk8()I

    move-result v12

    invoke-static {v12, v4}, Landroidx/compose/ui/graphics/StrokeJoin;->equals-impl0(II)Z

    move-result v12

    if-nez v12, :cond_a

    invoke-interface {v10, v4}, Landroidx/compose/ui/graphics/Paint;->setStrokeJoin-Ww9F2mQ(I)V

    .line 675
    :cond_a
    invoke-interface {v10}, Landroidx/compose/ui/graphics/Paint;->getPathEffect()Landroidx/compose/ui/graphics/PathEffect;
    ...
    invoke-interface {v10, v5}, Landroidx/compose/ui/graphics/Paint;->setPathEffect(Landroidx/compose/ui/graphics/PathEffect;)V
    ...
    .line 663
    .end local v10    # "$this$configureStrokePaint_ApHOwBQ_u24lambda_u2d10":Landroidx/compose/ui/graphics/Paint;
    .end local v11    # "$i$a$-apply-CanvasDrawScope$configureStrokePaint$2":I
    nop
...
.method private final configureStrokePaint-TuZ1BDo(JFFIILandroidx/compose/ui/graphics/PathEffect;FLandroidx/compose/ui/graphics/ColorFilter;I)Landroidx/compose/ui/graphics/Paint;
    ...
    .local v8, "$this$configureStrokePaint_TuZ1BDo_u24lambda_u2d9":Landroidx/compose/ui/graphics/Paint;
    const/4 v9, 0x0

    .line 640
    .local v9, "$i$a$-apply-CanvasDrawScope$configureStrokePaint$1":I
    ...
    invoke-direct {v10, v11, v12, v13}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->modulate-5vOe2sY(JF)J
    ...
    .end local v9    # "$i$a$-apply-CanvasDrawScope$configureStrokePaint$1":I
    .local v16, "$i$a$-apply-CanvasDrawScope$configureStrokePaint$1":I
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getColor-0d7_KjU()J
    ...
    invoke-interface {v8, v14, v15}, Landroidx/compose/ui/graphics/Paint;->setColor-8_81llA(J)V

    .line 642
    :cond_0
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getShader()Landroid/graphics/Shader;
    ...
    invoke-interface {v8, v9}, Landroidx/compose/ui/graphics/Paint;->setShader(Landroid/graphics/Shader;)V

    .line 643
    :cond_1
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getColorFilter()Landroidx/compose/ui/graphics/ColorFilter;
    ...
    invoke-interface {v8, v5}, Landroidx/compose/ui/graphics/Paint;->setColorFilter(Landroidx/compose/ui/graphics/ColorFilter;)V

    .line 644
    :cond_2
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getBlendMode-0nO6VwU()I

    move-result v9

    invoke-static {v9, v6}, Landroidx/compose/ui/graphics/BlendMode;->equals-impl0(II)Z

    move-result v9

    if-nez v9, :cond_3

    invoke-interface {v8, v6}, Landroidx/compose/ui/graphics/Paint;->setBlendMode-s9anfk8(I)V

    .line 645
    :cond_3
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getStrokeWidth()F
    ...
    invoke-interface {v8, v0}, Landroidx/compose/ui/graphics/Paint;->setStrokeWidth(F)V

    .line 646
    :cond_5
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getStrokeMiterLimit()F
    ...
    invoke-interface {v8, v1}, Landroidx/compose/ui/graphics/Paint;->setStrokeMiterLimit(F)V

    .line 647
    :cond_7
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getStrokeCap-KaPHkGw()I

    move-result v9

    invoke-static {v9, v2}, Landroidx/compose/ui/graphics/StrokeCap;->equals-impl0(II)Z

    move-result v9

    if-nez v9, :cond_8

    invoke-interface {v8, v2}, Landroidx/compose/ui/graphics/Paint;->setStrokeCap-BeK7IIE(I)V

    .line 648
    :cond_8
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getStrokeJoin-LxFBmk8()I

    move-result v9

    invoke-static {v9, v3}, Landroidx/compose/ui/graphics/StrokeJoin;->equals-impl0(II)Z

    move-result v9

    if-nez v9, :cond_9

    invoke-interface {v8, v3}, Landroidx/compose/ui/graphics/Paint;->setStrokeJoin-Ww9F2mQ(I)V

    .line 649
    :cond_9
    invoke-interface {v8}, Landroidx/compose/ui/graphics/Paint;->getPathEffect()Landroidx/compose/ui/graphics/PathEffect;
    ...
    invoke-interface {v8, v4}, Landroidx/compose/ui/graphics/Paint;->setPathEffect(Landroidx/compose/ui/graphics/PathEffect;)V
    ...
    .line 637
    .end local v8    # "$this$configureStrokePaint_TuZ1BDo_u24lambda_u2d9":Landroidx/compose/ui/graphics/Paint;
    .end local v14    # "targetColor":J
...
.method private final obtainFillPaint()Landroidx/compose/ui/graphics/Paint;
    ...
    .line 761
    .local v1, "$this$obtainFillPaint_u24lambda_u2d2":Landroidx/compose/ui/graphics/Paint;
    const/4 v2, 0x0
...
.method private final obtainStrokePaint()Landroidx/compose/ui/graphics/Paint;
    ...
    .line 761
    .local v1, "$this$obtainStrokePaint_u24lambda_u2d4":Landroidx/compose/ui/graphics/Paint;
    const/4 v2, 0x0
...
.method private final selectPaint(Landroidx/compose/ui/graphics/drawscope/DrawStyle;)Landroidx/compose/ui/graphics/Paint;
    ...
    .local v1, "$this$selectPaint_u24lambda_u2d6":Landroidx/compose/ui/graphics/Paint;
    const/4 v2, 0x0
    ...
    .line 574
    .end local v1    # "$this$selectPaint_u24lambda_u2d6":Landroidx/compose/ui/graphics/Paint;
...
.method public final draw-yzxVdVo(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/graphics/Canvas;JLkotlin/jvm/functions/Function1;)V
    ...
    .local v1, "$this$draw_yzxVdVo_u24lambda_u2d0":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;
    const/4 v7, 0x0
    ...
    .line 523
    .end local v1    # "$this$draw_yzxVdVo_u24lambda_u2d0":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;
    ...
    .local v1, "$this$draw_yzxVdVo_u24lambda_u2d1":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;
    const/4 v7, 0x0
    ...
    .line 532
    .end local v1    # "$this$draw_yzxVdVo_u24lambda_u2d1":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;
...
.method public drawArc-illE91I(Landroidx/compose/ui/graphics/Brush;FFZJJFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    invoke-interface/range {v9 .. v17}, Landroidx/compose/ui/graphics/Canvas;->drawArc(FFFFFFZLandroidx/compose/ui/graphics/Paint;)V
...
.method public drawCircle-V9BoPsw(Landroidx/compose/ui/graphics/Brush;FJFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    .line 294
    invoke-interface {v0, p3, p4, p2, v1}, Landroidx/compose/ui/graphics/Canvas;->drawCircle-9KIMszo(JFLandroidx/compose/ui/graphics/Paint;)V
...
.method public drawCircle-VaOC9Bg(JFJFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    invoke-interface {v9, p4, p5, p3, v1}, Landroidx/compose/ui/graphics/Canvas;->drawCircle-9KIMszo(JFLandroidx/compose/ui/graphics/Paint;)V
...
.method public drawImage-gbVJVH8(Landroidx/compose/ui/graphics/ImageBitmap;JFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    .line 207
    invoke-interface {v0, p1, p2, p3, v1}, Landroidx/compose/ui/graphics/Canvas;->drawImage-d-4ec7I(Landroidx/compose/ui/graphics/ImageBitmap;JLandroidx/compose/ui/graphics/Paint;)V
...
.method public drawOval-AsUm42w(Landroidx/compose/ui/graphics/Brush;JJFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    .line 330
    invoke-interface/range {v9 .. v14}, Landroidx/compose/ui/graphics/Canvas;->drawOval(FFFFLandroidx/compose/ui/graphics/Paint;)V
...
.method public drawPath-GBMwjPU(Landroidx/compose/ui/graphics/Path;Landroidx/compose/ui/graphics/Brush;FLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    .line 437
    invoke-interface {v0, p1, v1}, Landroidx/compose/ui/graphics/Canvas;->drawPath(Landroidx/compose/ui/graphics/Path;Landroidx/compose/ui/graphics/Paint;)V
