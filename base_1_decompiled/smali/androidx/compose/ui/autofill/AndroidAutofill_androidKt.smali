...
.method public static final performAutofill(Landroidx/compose/ui/autofill/AndroidAutofill;Landroid/util/SparseArray;)V
    ...
    .line 119
    invoke-virtual {v5, v3, v6}, Landroidx/compose/ui/autofill/AutofillTree;->performAutofill(ILjava/lang/String;)Lkotlin/Unit;
...
.method public static final populateViewStructure(Landroidx/compose/ui/autofill/AndroidAutofill;Landroid/view/ViewStructure;)V
    ...
    check-cast v21, Landroidx/compose/ui/autofill/AutofillType;

    .local v21, "it":Landroidx/compose/ui/autofill/AutofillType;
    const/16 v22, 0x0

    .line 89
    .local v22, "$i$a$-fastMap-AndroidAutofill_androidKt$populateViewStructure$1$1":I
    invoke-static/range {v21 .. v21}, Landroidx/compose/ui/autofill/AndroidAutofillType_androidKt;->getAndroidType(Landroidx/compose/ui/autofill/AutofillType;)Ljava/lang/String;

    move-result-object v2

    .end local v21    # "it":Landroidx/compose/ui/autofill/AutofillType;
    .end local v22    # "$i$a$-fastMap-AndroidAutofill_androidKt$populateViewStructure$1$1":I
    ...
    .line 87
    invoke-virtual {v6, v15, v8}, Landroidx/compose/ui/autofill/AutofillApi26Helper;->setAutofillHints(Landroid/view/ViewStructure;[Ljava/lang/String;)V
    ...
    .local v0, "$this$populateViewStructure_u24lambda_u2d2_u24lambda_u2d1":Landroid/graphics/Rect;
    :cond_5
    const/4 v2, 0x0

    .line 102
    .local v2, "$i$a$-run-AndroidAutofill_androidKt$populateViewStructure$1$2":I
    ...
    .end local v0    # "$this$populateViewStructure_u24lambda_u2d2_u24lambda_u2d1":Landroid/graphics/Rect;
    .end local v2    # "$i$a$-run-AndroidAutofill_androidKt$populateViewStructure$1$2":I
    goto :goto_3
    ...
    .local v0, "$this$toTypedArray$iv":Ljava/util/Collection;
    .local v2, "$i$f$toTypedArray":I
    .restart local v4    # "autofillNode":Landroidx/compose/ui/autofill/AutofillNode;
    .restart local v5    # "id":I
    .restart local v7    # "thisCollection$iv":Ljava/util/Collection;
    .restart local v15    # "child":Landroid/view/ViewStructure;
    .restart local v16    # "$i$a$-also-AndroidAutofill_androidKt$populateViewStructure$1":I
    :cond_6
