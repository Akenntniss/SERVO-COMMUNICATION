...
.method public static final synthetic access$bringIntoView(Landroidx/compose/ui/input/nestedscroll/NestedScrollDelegatingWrapper;Landroidx/compose/ui/layout/LayoutCoordinates;)V
    .locals 0
    .param p0, "$receiver"    # Landroidx/compose/ui/input/nestedscroll/NestedScrollDelegatingWrapper;
    .param p1, "child"    # Landroidx/compose/ui/layout/LayoutCoordinates;
...
.method private static final bringIntoView(Landroidx/compose/ui/input/nestedscroll/NestedScrollDelegatingWrapper;Landroidx/compose/ui/layout/LayoutCoordinates;)V
    .locals 9
    .param p0, "$this$bringIntoView"    # Landroidx/compose/ui/input/nestedscroll/NestedScrollDelegatingWrapper;
    .param p1, "child"    # Landroidx/compose/ui/layout/LayoutCoordinates;
    ...
    .line 85
    .local v0, "childBounds":Landroidx/compose/ui/geometry/Rect;
    ...
    invoke-static {v2, v3, v4}, Landroidx/compose/ui/layout/RelocationRequesterModifierKt;->calculateOffset(FFF)F
    ...
    invoke-interface {v3}, Landroidx/compose/ui/input/nestedscroll/NestedScrollModifier;->getConnection()Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;
    ...
    invoke-virtual {v6}, Landroidx/compose/ui/input/nestedscroll/NestedScrollSource$Companion;->getRelocate-WNlRxjI()I

    move-result v8

    move-wide v6, v1

    invoke-interface/range {v3 .. v8}, Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;->onPostScroll-DzOQY0M(JJI)J
    ...
    :cond_0
    invoke-virtual {v3}, Landroidx/compose/ui/node/LayoutNodeWrapper;->findPreviousNestedScrollWrapper()Landroidx/compose/ui/input/nestedscroll/NestedScrollDelegatingWrapper;
    ...
    :cond_1
    invoke-static {v3, p1}, Landroidx/compose/ui/layout/RelocationRequesterModifierKt;->bringIntoView(Landroidx/compose/ui/input/nestedscroll/NestedScrollDelegatingWrapper;Landroidx/compose/ui/layout/LayoutCoordinates;)V
...
.method private static final calculateOffset(FFF)F
    .locals 2
    .param p0, "leadingEdge"    # F
    .param p1, "trailingEdge"    # F
    .param p2, "parentSize"    # F
...
.method public static final relocationRequester(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/layout/RelocationRequester;)Landroidx/compose/ui/Modifier;
    ...
    .param p1, "relocationRequester"    # Landroidx/compose/ui/layout/RelocationRequester;
    ...
    new-instance v1, Landroidx/compose/ui/layout/RelocationRequesterModifierKt$relocationRequester$$inlined$debugInspectorInfo$1;

    invoke-direct {v1, p1}, Landroidx/compose/ui/layout/RelocationRequesterModifierKt$relocationRequester$$inlined$debugInspectorInfo$1;-><init>(Landroidx/compose/ui/layout/RelocationRequester;)V
    ...
    :goto_0
    new-instance v0, Landroidx/compose/ui/layout/RelocationRequesterModifierKt$relocationRequester$2;

    invoke-direct {v0, p1}, Landroidx/compose/ui/layout/RelocationRequesterModifierKt$relocationRequester$2;-><init>(Landroidx/compose/ui/layout/RelocationRequester;)V
