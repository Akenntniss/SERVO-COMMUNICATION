...
.method public static final DisposableSaveableStateRegistry(Landroid/view/View;Landroidx/savedstate/SavedStateRegistryOwner;)Landroidx/compose/ui/platform/DisposableSaveableStateRegistry;
    ...
    .end local v1    # "idFromTag":Ljava/lang/String;
...
.method private static final toBundle(Ljava/util/Map;)Landroid/os/Bundle;
    ...
    .local v5, "$dstr$key$list":Ljava/util/Map$Entry;
    const/4 v6, 0x0

    .line 174
    .local v6, "$i$a$-forEach-DisposableSaveableStateRegistry_androidKt$toBundle$1":I
    ...
    .line 176
    invoke-virtual {v0, v7, v9}, Landroid/os/Bundle;->putParcelableArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V

    .line 180
    nop

    .end local v4    # "element$iv":Ljava/util/Map$Entry;
    .end local v5    # "$dstr$key$list":Ljava/util/Map$Entry;
    .end local v6    # "$i$a$-forEach-DisposableSaveableStateRegistry_androidKt$toBundle$1":I
...
.method private static final toMap(Landroid/os/Bundle;)Ljava/util/Map;
    ...
    .restart local v6    # "$i$a$-forEach-DisposableSaveableStateRegistry_androidKt$toMap$1":I
    :cond_0
