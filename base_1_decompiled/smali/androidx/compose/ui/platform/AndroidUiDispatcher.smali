...
.method private final nextTask()Ljava/lang/Runnable;
    ...
    .line 74
    .local v1, "$i$a$-synchronized-AndroidUiDispatcher$nextTask$1":I
    :try_start_0
    iget-object v2, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->toRunTrampolined:Lkotlin/collections/ArrayDeque;
    ...
    .line 73
    .end local v1    # "$i$a$-synchronized-AndroidUiDispatcher$nextTask$1":I
    monitor-exit v0
...
.method private final performFrameDispatch(J)V
    ...
    .line 100
    .local v1, "$i$a$-synchronized-AndroidUiDispatcher$performFrameDispatch$toRun$1":I
    :try_start_0
    iget-boolean v2, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->scheduledFrameDispatch:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-nez v2, :cond_0

    .end local v1    # "$i$a$-synchronized-AndroidUiDispatcher$performFrameDispatch$toRun$1":I
    monitor-exit v0

    return-void

    .line 101
    .restart local v1    # "$i$a$-synchronized-AndroidUiDispatcher$performFrameDispatch$toRun$1":I
    :cond_0
    const/4 v2, 0x0

    :try_start_1
    iput-boolean v2, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->scheduledFrameDispatch:Z
    ...
    invoke-interface {v4, p1, p2}, Landroid/view/Choreographer$FrameCallback;->doFrame(J)V
    ...
    .line 99
    .end local v0    # "toRun":Ljava/util/List;
    :catchall_0
    move-exception v1
...
.method private final performTrampolineDispatch()V
    ...
    .line 89
    :cond_1
    iget-object v1, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->lock:Ljava/lang/Object;
...
.method public dispatch(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    .line 138
    .local v1, "$i$a$-synchronized-AndroidUiDispatcher$dispatch$1":I
    :try_start_0
    iget-object v2, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->toRunTrampolined:Lkotlin/collections/ArrayDeque;

    invoke-virtual {v2, p2}, Lkotlin/collections/ArrayDeque;->addLast(Ljava/lang/Object;)V

    .line 139
    iget-boolean v2, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->scheduledTrampolineDispatch:Z
    ...
    .line 141
    iget-object v3, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->handler:Landroid/os/Handler;
    ...
    iget-object v3, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->dispatchCallback:Landroidx/compose/ui/platform/AndroidUiDispatcher$dispatchCallback$1;
    ...
    .end local v1    # "$i$a$-synchronized-AndroidUiDispatcher$dispatch$1":I
...
.method public final postFrameCallback$ui_release(Landroid/view/Choreographer$FrameCallback;)V
    ...
    .line 116
    .local v1, "$i$a$-synchronized-AndroidUiDispatcher$postFrameCallback$1":I
    :try_start_0
    ...
    .end local v1    # "$i$a$-synchronized-AndroidUiDispatcher$postFrameCallback$1":I
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final removeFrameCallback$ui_release(Landroid/view/Choreographer$FrameCallback;)V
    ...
    .line 126
    .local v1, "$i$a$-synchronized-AndroidUiDispatcher$removeFrameCallback$1":I
    :try_start_0
    iget-object v2, p0, Landroidx/compose/ui/platform/AndroidUiDispatcher;->toRunOnFrame:Ljava/util/List;
    ...
    .line 125
    .end local v1    # "$i$a$-synchronized-AndroidUiDispatcher$removeFrameCallback$1":I
    monitor-exit v0
