...
.method public constructor <init>(Landroidx/compose/ui/text/font/FontMatcher;Landroidx/compose/ui/text/font/Font$ResourceLoader;)V
    .locals 1
    .param p1, "fontMatcher"    # Landroidx/compose/ui/text/font/FontMatcher;
...
.method private final create-RetOiIg(Ljava/lang/String;Landroidx/compose/ui/text/font/FontWeight;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p3, v3}, Landroidx/compose/ui/text/font/FontStyle;->equals-impl0(II)Z

    move-result v3

    .line 216
    invoke-virtual {v1, v0, v2, v3}, Landroidx/compose/ui/text/platform/TypefaceAdapterHelperMethods;->create(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;

    move-result-object v1

    .line 202
    .end local v0    # "familyTypeface":Landroid/graphics/Typeface;
    :goto_5
    return-object v1
.end method
...
.method private final create-xC2X5gM(ILandroidx/compose/ui/text/font/FontWeight;Landroidx/compose/ui/text/font/FontListFontFamily;I)Landroid/graphics/Typeface;
    ...
    .param p2, "fontWeight"    # Landroidx/compose/ui/text/font/FontWeight;
    .param p3, "fontFamily"    # Landroidx/compose/ui/text/font/FontListFontFamily;
    ...
    .line 246
    :try_start_0
    instance-of v1, v0, Landroidx/compose/ui/text/font/ResourceFont;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroidx/compose/ui/text/platform/TypefaceAdapter;->resourceLoader:Landroidx/compose/ui/text/font/Font$ResourceLoader;

    invoke-interface {v1, v0}, Landroidx/compose/ui/text/font/Font$ResourceLoader;->load(Landroidx/compose/ui/text/font/Font;)Ljava/lang/Object;
    ...
    .line 247
    :cond_0
    instance-of v1, v0, Landroidx/compose/ui/text/font/AndroidFont;
    ...
    .line 256
    .local v8, "loadedFontIsSameAsRequest":Z
    ...
    invoke-static {p4, v1}, Landroidx/compose/ui/text/font/FontSynthesis;->equals-impl0(II)Z
    ...
    .end local v8    # "loadedFontIsSameAsRequest":Z
    :cond_4
    :try_start_1
    ...
    .end local p1    # "fontStyle":I
    .end local p2    # "fontWeight":Landroidx/compose/ui/text/font/FontWeight;
    .end local p3    # "fontFamily":Landroidx/compose/ui/text/font/FontListFontFamily;
    .end local p4    # "fontSynthesis":I
    throw v1
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0

    .line 250
    .restart local v0    # "font":Landroidx/compose/ui/text/font/Font;
    .restart local p1    # "fontStyle":I
    .restart local p2    # "fontWeight":Landroidx/compose/ui/text/font/FontWeight;
    .restart local p3    # "fontFamily":Landroidx/compose/ui/text/font/FontListFontFamily;
    .restart local p4    # "fontSynthesis":I
    :catch_0
    move-exception v1
    ...
    const-string v3, "Cannot create Typeface from "
...
.method public create-DPcqOEQ(Landroidx/compose/ui/text/font/FontFamily;Landroidx/compose/ui/text/font/FontWeight;II)Landroid/graphics/Typeface;
    ...
    .line 143
    .local v0, "cacheKey":Landroidx/compose/ui/text/platform/TypefaceAdapter$CacheKey;
    ...
    .line 144
    .local v2, "cachedTypeface":Landroid/graphics/Typeface;
    if-eqz v2, :cond_0
    ...
    .line 147
    instance-of v3, p1, Landroidx/compose/ui/text/font/FontListFontFamily;
    ...
    .line 147
    invoke-direct {p0, p3, p2, v3, p4}, Landroidx/compose/ui/text/platform/TypefaceAdapter;->create-xC2X5gM(ILandroidx/compose/ui/text/font/FontWeight;Landroidx/compose/ui/text/font/FontListFontFamily;I)Landroid/graphics/Typeface;
    ...
    .line 153
    :cond_1
    instance-of v3, p1, Landroidx/compose/ui/text/font/GenericFontFamily;
    ...
    .line 154
    invoke-direct {p0, v3, p2, p3}, Landroidx/compose/ui/text/platform/TypefaceAdapter;->create-RetOiIg(Ljava/lang/String;Landroidx/compose/ui/text/font/FontWeight;I)Landroid/graphics/Typeface;
    ...
    .line 159
    :cond_2
    instance-of v3, p1, Landroidx/compose/ui/text/font/DefaultFontFamily;
    ...
    .line 165
    :cond_5
    instance-of v3, p1, Landroidx/compose/ui/text/font/LoadedFontFamily;
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/text/font/LoadedFontFamily;->getTypeface()Landroidx/compose/ui/text/font/Typeface;

    move-result-object v3

    check-cast v3, Landroidx/compose/ui/text/platform/AndroidTypeface;

    .line 167
    nop

    .line 166
    invoke-interface {v3, p2, p3, p4}, Landroidx/compose/ui/text/platform/AndroidTypeface;->getNativeTypeface-PYhJU0U(Landroidx/compose/ui/text/font/FontWeight;II)Landroid/graphics/Typeface;
