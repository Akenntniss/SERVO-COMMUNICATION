...
.method public constructor <init>(Ljava/lang/CharSequence;FLandroid/text/TextPaint;ILandroid/text/TextUtils$TruncateAt;IFFZIIII[I[ILandroidx/compose/ui/text/android/LayoutIntrinsics;)V
    ...
    .param p11, "breakStrategy"    # I
    .param p12, "hyphenationFrequency"    # I
    .param p13, "justificationMode"    # I
    .param p14, "leftIndents"    # [I
    .param p15, "rightIndents"    # [I
    .param p16, "layoutIntrinsics"    # Landroidx/compose/ui/text/android/LayoutIntrinsics;
    ...
    const-string v1, "layoutIntrinsics"
    ...
    .line 105
    iput-object v12, v0, Landroidx/compose/ui/text/android/TextLayout;->layoutIntrinsics:Landroidx/compose/ui/text/android/LayoutIntrinsics;
    ...
    .line 130
    .local v23, "frameworkTextDir":Landroid/text/TextDirectionHeuristic;
    sget-object v1, Landroidx/compose/ui/text/android/TextAlignmentAdapter;->INSTANCE:Landroidx/compose/ui/text/android/TextAlignmentAdapter;

    move/from16 v9, p4

    invoke-virtual {v1, v9}, Landroidx/compose/ui/text/android/TextAlignmentAdapter;->get(I)Landroid/text/Layout$Alignment;
    ...
    invoke-interface {v1, v2, v11, v3}, Landroid/text/Spanned;->nextSpanTransition(IILjava/lang/Class;)I
    ...
    .line 141
    .local v27, "hasBaselineShiftSpans":Z
    ...
    .line 143
    .local v28, "boringMetrics":Landroid/text/BoringLayout$Metrics;
    ...
    .end local v8    # "widthInt":I
    .local v29, "widthInt":I
    ...
    .line 145
    .end local v29    # "widthInt":I
    .restart local v8    # "widthInt":I
    :cond_2
    move/from16 v29, v8

    .end local v8    # "widthInt":I
    .restart local v29    # "widthInt":I
    goto :goto_1
    ...
    .line 216
    .end local v23    # "frameworkTextDir":Landroid/text/TextDirectionHeuristic;
    .end local v24    # "frameworkAlignment":Landroid/text/Layout$Alignment;
    .end local v27    # "hasBaselineShiftSpans":Z
    .end local v28    # "boringMetrics":Landroid/text/BoringLayout$Metrics;
    .end local v29    # "widthInt":I
    .end local v30    # "end":I
    nop
