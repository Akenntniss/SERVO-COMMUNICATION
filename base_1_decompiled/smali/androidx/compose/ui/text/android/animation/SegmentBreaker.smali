...
.method private final breakInWords(Landroidx/compose/ui/text/android/LayoutHelper;)Ljava/util/List;
    ...
    const-string v3, "getLineInstance(Locale.getDefault())"

    invoke-static {v2, v3}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    move-object/from16 v3, p0

    invoke-direct {v3, v1, v2}, Landroidx/compose/ui/text/android/animation/SegmentBreaker;->breakWithBreakIterator(Ljava/lang/CharSequence;Ljava/text/BreakIterator;)Ljava/util/List;

    move-result-object v2

    .line 65
    .local v2, "words":Ljava/util/List;
    ...
    .local v5, "$this$breakInWords_u24lambda_u2d1":Ljava/util/TreeSet;
    const/4 v6, 0x0

    .line 66
    .local v6, "$i$a$-apply-SegmentBreaker$breakInWords$set$1":I
    move-object v7, v2
    ...
    .line 66
    .local v15, "$i$a$-fastForEach-SegmentBreaker$breakInWords$set$1$1":I
    ...
    .end local v14    # "it":I
    .end local v15    # "$i$a$-fastForEach-SegmentBreaker$breakInWords$set$1$1":I
    if-le v11, v9, :cond_0
    ...
    .line 65
    .end local v5    # "$this$breakInWords_u24lambda_u2d1":Ljava/util/TreeSet;
    .end local v6    # "$i$a$-apply-SegmentBreaker$breakInWords$set$1":I
    nop

    .line 69
    .local v4, "set":Ljava/util/TreeSet;
    ...
    .local v7, "paraIndex":I
    add-int/lit8 v6, v6, 0x1

    .line 70
    invoke-virtual {v0, v7}, Landroidx/compose/ui/text/android/LayoutHelper;->analyzeBidi(I)Ljava/text/Bidi;
    ...
    .line 71
    .local v8, "bidi":Ljava/text/Bidi;
    :cond_3
    invoke-virtual {v0, v7}, Landroidx/compose/ui/text/android/LayoutHelper;->getParagraphStart(I)I
    ...
    .line 73
    invoke-virtual {v8, v12}, Ljava/text/Bidi;->getRunStart(I)I
    ...
    .line 69
    .end local v8    # "bidi":Ljava/text/Bidi;
...
.method private final breakSegmentWithChar(Landroidx/compose/ui/text/android/LayoutHelper;Z)Ljava/util/List;
    ...
    .line 276
    .local v21, "$i$a$-fastZipWithNext-SegmentBreaker$breakSegmentWithChar$1":I
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/ui/text/android/LayoutHelper;->getLayout()Landroid/text/Layout;
    ...
    .line 283
    .local v6, "lineNo":I
    invoke-virtual {v14, v6}, Landroid/text/Layout;->getParagraphDirection(I)I
    ...
    .local v25, "$i$f$fastZipWithNext":I
    ...
    .local v23, "result$iv":Ljava/util/List;
    ...
    .end local v22    # "lineNo":I
    .restart local v6    # "lineNo":I
    invoke-virtual {v14, v6}, Landroid/text/Layout;->getLineTop(I)I
    ...
    .local v22, "layout":Landroid/text/Layout;
    move-object v14, v5
    ...
    .end local v13    # "end":I
    .end local v21    # "$i$a$-fastZipWithNext-SegmentBreaker$breakSegmentWithChar$1":I
    .end local v22    # "layout":Landroid/text/Layout;
    ...
    .end local v23    # "result$iv":Ljava/util/List;
    ...
    .end local v25    # "$i$f$fastZipWithNext":I
    .local v2, "$this$fastZipWithNext$iv":Ljava/util/List;
    .local v4, "$i$f$fastZipWithNext":I
    .restart local v5    # "result$iv":Ljava/util/List;
    :cond_6
    move-object/from16 v24, v2
    ...
    .restart local v25    # "$i$f$fastZipWithNext":I
    :goto_5
    goto :goto_7
...
.method private final breakSegmentWithParagraph(Landroidx/compose/ui/text/android/LayoutHelper;)Ljava/util/List;
    ...
    invoke-virtual {v0, v6}, Landroidx/compose/ui/text/android/LayoutHelper;->getParagraphEnd(I)I

    move-result v14

    .line 183
    .local v14, "paraEnd":I
    invoke-static {v2, v15, v4}, Landroidx/compose/ui/text/android/LayoutCompatKt;->getLineForOffset(Landroid/text/Layout;IZ)I

    move-result v13

    .line 184
    .local v13, "paraFirstLine":I
    invoke-static {v2, v14, v7}, Landroidx/compose/ui/text/android/LayoutCompatKt;->getLineForOffset(Landroid/text/Layout;IZ)I

    move-result v7

    .line 185
    .local v7, "paraLastLine":I
    nop
    ...
    .end local v13    # "paraFirstLine":I
    .local v16, "paraFirstLine":I
    move/from16 v13, v17

    move/from16 v17, v14

    .end local v14    # "paraEnd":I
    .local v17, "paraEnd":I
    move/from16 v14, v18

    invoke-direct/range {v8 .. v14}, Landroidx/compose/ui/text/android/animation/Segment;-><init>(IIIIII)V

    .line 185
    invoke-interface {v1, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 180
    .end local v7    # "paraLastLine":I
    .end local v15    # "paraStart":I
    .end local v16    # "paraFirstLine":I
    .end local v17    # "paraEnd":I
    if-lt v5, v3, :cond_0
...
.method private final breakSegmentWithWord(Landroidx/compose/ui/text/android/LayoutHelper;Z)Ljava/util/List;
    ...
    .line 326
    .local v13, "next$iv":Ljava/lang/Object;
    move-object v14, v13
    ...
    .line 227
    .local v22, "$i$a$-fastZipWithNext-SegmentBreaker$breakSegmentWithWord$1":I
    ...
    .local v25, "$this$fastZipWithNext$iv":Ljava/util/List;
    const/4 v3, -0x1
    ...
    .local v26, "$i$f$fastZipWithNext":I
    ...
    .local v24, "result$iv":Ljava/util/List;
    float-to-double v5, v4
    ...
    invoke-virtual {v0, v14, v5, v6}, Landroidx/compose/ui/text/android/LayoutHelper;->getHorizontalPosition(IZZ)F
    ...
    invoke-direct/range {v15 .. v21}, Landroidx/compose/ui/text/android/animation/Segment;-><init>(IIIIII)V
    ...
    .end local v14    # "end":I
    .end local v22    # "$i$a$-fastZipWithNext-SegmentBreaker$breakSegmentWithWord$1":I
    .end local v23    # "start":I
    .end local v24    # "result$iv":Ljava/util/List;
    .end local v27    # "paraRTL":Z
    .local v0, "result$iv":Ljava/util/List;
    ...
    .line 324
    .end local v13    # "next$iv":Ljava/lang/Object;
    ...
    .end local v0    # "result$iv":Ljava/util/List;
    .end local v12    # "i$iv":I
    .end local v25    # "$this$fastZipWithNext$iv":Ljava/util/List;
    .end local v26    # "$i$f$fastZipWithNext":I
    .local v3, "$this$fastZipWithNext$iv":Ljava/util/List;
    .local v5, "$i$f$fastZipWithNext":I
    .local v6, "result$iv":Ljava/util/List;
    :cond_9
    ...
    .end local v5    # "$i$f$fastZipWithNext":I
    .end local v6    # "result$iv":Ljava/util/List;
    .restart local v0    # "result$iv":Ljava/util/List;
    .restart local v25    # "$this$fastZipWithNext$iv":Ljava/util/List;
    .restart local v26    # "$i$f$fastZipWithNext":I
    :goto_5
    move-object v6, v0
...
.method public final breakOffsets(Landroidx/compose/ui/text/android/LayoutHelper;Landroidx/compose/ui/text/android/animation/SegmentType;)Ljava/util/List;
    ...
    .line 112
    .local v6, "$i$a$-also-SegmentBreaker$breakOffsets$2":I
    ...
    .end local v6    # "$i$a$-also-SegmentBreaker$breakOffsets$2":I
    goto :goto_0
    ...
    .restart local v5    # "it":Ljava/util/List;
    const/4 v6, 0x0

    .line 105
    .local v6, "$i$a$-also-SegmentBreaker$breakOffsets$1":I
    ...
    .line 106
    invoke-virtual {p1, v8}, Landroidx/compose/ui/text/android/LayoutHelper;->getParagraphEnd(I)I
    ...
    .line 104
    .end local v5    # "it":Ljava/util/List;
    .end local v6    # "$i$a$-also-SegmentBreaker$breakOffsets$1":I
    goto :goto_0
