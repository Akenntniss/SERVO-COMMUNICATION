...
.method public final apply(Ljava/util/List;)Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    check-cast v8, Landroidx/compose/ui/text/input/EditCommand;

    .local v8, "it":Landroidx/compose/ui/text/input/EditCommand;
    const/4 v9, 0x0

    .line 93
    .local v9, "$i$a$-fastForEach-EditProcessor$apply$1":I
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/text/input/EditProcessor;->getMBuffer$ui_text_release()Landroidx/compose/ui/text/input/EditingBuffer;

    move-result-object v10

    invoke-interface {v8, v10}, Landroidx/compose/ui/text/input/EditCommand;->applyTo(Landroidx/compose/ui/text/input/EditingBuffer;)V

    .line 115
    .end local v7    # "item$iv":Ljava/lang/Object;
    .end local v8    # "it":Landroidx/compose/ui/text/input/EditCommand;
    .end local v9    # "$i$a$-fastForEach-EditProcessor$apply$1":I
    if-le v5, v4, :cond_0
    ...
    .line 96
    iget-object v3, v0, Landroidx/compose/ui/text/input/EditProcessor;->mBuffer:Landroidx/compose/ui/text/input/EditingBuffer;

    invoke-virtual {v3}, Landroidx/compose/ui/text/input/EditingBuffer;->toAnnotatedString$ui_text_release()Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/text/input/EditingBuffer;->getSelectionStart$ui_text_release()I

    move-result v3

    iget-object v4, v0, Landroidx/compose/ui/text/input/EditProcessor;->mBuffer:Landroidx/compose/ui/text/input/EditingBuffer;

    invoke-virtual {v4}, Landroidx/compose/ui/text/input/EditingBuffer;->getSelectionEnd$ui_text_release()I
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/text/input/EditingBuffer;->hasComposition$ui_text_release()Z
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/text/input/EditingBuffer;->getCompositionStart$ui_text_release()I

    move-result v3

    iget-object v4, v0, Landroidx/compose/ui/text/input/EditProcessor;->mBuffer:Landroidx/compose/ui/text/input/EditingBuffer;

    invoke-virtual {v4}, Landroidx/compose/ui/text/input/EditingBuffer;->getCompositionEnd$ui_text_release()I
    ...
    invoke-direct/range {v11 .. v16}, Landroidx/compose/ui/text/input/TextFieldValue;-><init>(Landroidx/compose/ui/text/AnnotatedString;JLandroidx/compose/ui/text/TextRange;Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 105
    .local v1, "newState":Landroidx/compose/ui/text/input/TextFieldValue;
    iput-object v1, v0, Landroidx/compose/ui/text/input/EditProcessor;->mBufferState:Landroidx/compose/ui/text/input/TextFieldValue;
...
.method public final reset(Landroidx/compose/ui/text/input/TextFieldValue;Landroidx/compose/ui/text/input/TextInputSession;)V
    ...
    .line 78
    .local v0, "oldValue":Landroidx/compose/ui/text/input/TextFieldValue;
