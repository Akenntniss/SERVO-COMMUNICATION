...
.method public constructor <init>(Lkotlin/coroutines/CoroutineContext;)V
    ...
    .local v2, "$this$effectJob_u24lambda_u2d0":Lkotlinx/coroutines/CompletableJob;
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$effectJob_u24lambda_u2d0":Lkotlinx/coroutines/CompletableJob;
    ...
    iput-object v0, p0, Landroidx/compose/runtime/Recomposer;->snapshotInvalidations:Ljava/util/List;
...
.method private final getHasSchedulingWork()Z
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/compose/runtime/Recomposer;->snapshotInvalidations:Ljava/util/List;
...
.method private final performRecompose(Landroidx/compose/runtime/ControlledComposition;Landroidx/compose/runtime/collection/IdentityArraySet;)Landroidx/compose/runtime/ControlledComposition;
    ...
    .line 1055
    invoke-static {v0, p1}, Landroidx/compose/runtime/Recomposer;->access$readObserverOf(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/ControlledComposition;)Lkotlin/jvm/functions/Function1;

    move-result-object v4

    invoke-static {v0, p1, p2}, Landroidx/compose/runtime/Recomposer;->access$writeObserverOf(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/ControlledComposition;Landroidx/compose/runtime/collection/IdentityArraySet;)Lkotlin/jvm/functions/Function1;
    ...
    invoke-static {v0, v3}, Landroidx/compose/runtime/Recomposer;->access$applyAndCheck(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/snapshots/MutableSnapshot;)V
...
.method private final recordComposerModificationsLocked()V
    ...
    iget-object v1, v0, Landroidx/compose/runtime/Recomposer;->snapshotInvalidations:Ljava/util/List;
    ...
    .local v8, "changes":Ljava/util/Set;
    const/4 v9, 0x0

    .line 344
    .local v9, "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$1":I
    iget-object v10, v0, Landroidx/compose/runtime/Recomposer;->knownCompositions:Ljava/util/List;
    ...
    .line 345
    .local v16, "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$1$1":I
    invoke-interface {v4, v8}, Landroidx/compose/runtime/ControlledComposition;->recordModificationsOf(Ljava/util/Set;)V
    ...
    .end local v16    # "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$1$1":I
    ...
    .end local v8    # "changes":Ljava/util/Set;
    .end local v9    # "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$1":I
    if-le v5, v3, :cond_0
...
.method private final recordComposerModificationsLocked(Lkotlin/jvm/functions/Function1;)V
    ...
    .line 358
    .local v0, "$i$f$recordComposerModificationsLocked":I
    invoke-static/range {p0 .. p0}, Landroidx/compose/runtime/Recomposer;->access$getSnapshotInvalidations$p(Landroidx/compose/runtime/Recomposer;)Ljava/util/List;
    ...
    .line 360
    .local v9, "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$2":I
    invoke-static/range {p0 .. p0}, Landroidx/compose/runtime/Recomposer;->access$getKnownCompositions$p(Landroidx/compose/runtime/Recomposer;)Ljava/util/List;
    ...
    .line 361
    .local v17, "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$2$1":I
    invoke-interface {v2, v8}, Landroidx/compose/runtime/ControlledComposition;->recordModificationsOf(Ljava/util/Set;)V
    ...
    .end local v15    # "item$iv":Ljava/lang/Object;
    .end local v17    # "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$2$1":I
    if-le v13, v12, :cond_1
    ...
    .end local v7    # "item$iv":Ljava/lang/Object;
    .end local v8    # "changes":Ljava/util/Set;
    .end local v9    # "$i$a$-fastForEach-Recomposer$recordComposerModificationsLocked$2":I
    if-le v5, v4, :cond_0
    ...
    .line 366
    :cond_4
    invoke-static/range {p0 .. p0}, Landroidx/compose/runtime/Recomposer;->access$getCompositionInvalidations$p(Landroidx/compose/runtime/Recomposer;)Ljava/util/List;
...
.method private final registerRunnerJob(Lkotlinx/coroutines/Job;)V
    ...
    :cond_0
    :try_start_1
    const-string v3, "Recomposer already running"
    ...
    :cond_1
    const-string v3, "Recomposer shut down"
...
.method private final runFrameLoop(Landroidx/compose/runtime/MonotonicFrameClock;Landroidx/compose/runtime/ProduceFrameSignal;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object p2, p3, Landroidx/compose/runtime/Recomposer$runFrameLoop$1;->L$4:Ljava/lang/Object;
    ...
    .end local v2    # "this":Landroidx/compose/runtime/Recomposer;
    .end local v3    # "toRecompose":Ljava/util/List;
    .end local p1    # "parentFrameClock":Landroidx/compose/runtime/MonotonicFrameClock;
    .end local p2    # "frameSignal":Landroidx/compose/runtime/ProduceFrameSignal;
    if-ne v5, v1, :cond_1
    ...
    .line 560
    .end local v4    # "toApply":Ljava/util/List;
    .local p1, "toApply":Ljava/util/List;
    :goto_2
...
.method public composeInitial$runtime_release(Landroidx/compose/runtime/ControlledComposition;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 1043
    invoke-static {v2, p1}, Landroidx/compose/runtime/Recomposer;->access$readObserverOf(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/ControlledComposition;)Lkotlin/jvm/functions/Function1;

    move-result-object v5

    invoke-static {v2, p1, v1}, Landroidx/compose/runtime/Recomposer;->access$writeObserverOf(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/ControlledComposition;Landroidx/compose/runtime/collection/IdentityArraySet;)Lkotlin/jvm/functions/Function1;
    ...
    .line 1045
    .local v4, "snapshot$iv":Landroidx/compose/runtime/snapshots/MutableSnapshot;
    nop
    ...
    .line 727
    .local v8, "$i$a$-composing-Recomposer$composeInitial$1":I
    :try_start_1
    ...
    .end local v8    # "$i$a$-composing-Recomposer$composeInitial$1":I
    sget-object v8, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_1
    ...
    invoke-static {v2, v4}, Landroidx/compose/runtime/Recomposer;->access$applyAndCheck(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/snapshots/MutableSnapshot;)V
    ...
    .end local v4    # "snapshot$iv":Landroidx/compose/runtime/snapshots/MutableSnapshot;
    if-nez v0, :cond_0
    ...
    .local v2, "this_$iv":Landroidx/compose/runtime/Recomposer;
    .local v3, "$i$f$composing":I
    .restart local v4    # "snapshot$iv":Landroidx/compose/runtime/snapshots/MutableSnapshot;
