...
.method private final fail(Ljava/lang/Throwable;)V
    ...
    check-cast v9, Landroidx/compose/runtime/BroadcastFrameClock$FrameAwaiter;

    .local v9, "awaiter":Landroidx/compose/runtime/BroadcastFrameClock$FrameAwaiter;
    const/4 v10, 0x0

    .line 116
    .local v10, "$i$a$-fastForEach-BroadcastFrameClock$fail$1$1":I
    invoke-virtual {v9}, Landroidx/compose/runtime/BroadcastFrameClock$FrameAwaiter;->getContinuation()Lkotlin/coroutines/Continuation;
    ...
    .end local v10    # "$i$a$-fastForEach-BroadcastFrameClock$fail$1$1":I
    if-le v6, v5, :cond_1
...
.method public final sendFrame(J)V
    ...
    invoke-virtual {v7, p1, p2}, Landroidx/compose/runtime/BroadcastFrameClock$FrameAwaiter;->resume(J)V
...
.method public withFrameNanos(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .restart local v11    # "$i$f$synchronized":I
    .restart local v12    # "cause":Ljava/lang/Throwable;
    .restart local v13    # "hadAwaiters":Z
    :cond_5
    :try_start_4
