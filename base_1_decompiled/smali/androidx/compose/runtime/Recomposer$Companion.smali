...
.method public final loadStateAndComposeForHotReload$runtime_release(Ljava/lang/Object;)V
    ...
    check-cast v8, Landroidx/compose/runtime/Recomposer$HotReloadable;

    .local v8, "it":Landroidx/compose/runtime/Recomposer$HotReloadable;
    const/4 v9, 0x0

    .line 926
    .local v9, "$i$a$-fastForEach-Recomposer$Companion$loadStateAndComposeForHotReload$1":I
    invoke-virtual {v8}, Landroidx/compose/runtime/Recomposer$HotReloadable;->resetContent()V

    .line 1002
    .end local v7    # "item$iv":Ljava/lang/Object;
    .end local v8    # "it":Landroidx/compose/runtime/Recomposer$HotReloadable;
    .end local v9    # "$i$a$-fastForEach-Recomposer$Companion$loadStateAndComposeForHotReload$1":I
    if-le v5, v3, :cond_0
    ...
    check-cast v7, Landroidx/compose/runtime/Recomposer$HotReloadable;

    .local v7, "it":Landroidx/compose/runtime/Recomposer$HotReloadable;
    const/4 v8, 0x0

    .line 927
    .local v8, "$i$a$-fastForEach-Recomposer$Companion$loadStateAndComposeForHotReload$2":I
    invoke-virtual {v7}, Landroidx/compose/runtime/Recomposer$HotReloadable;->recompose()V

    .line 1008
    .end local v6    # "item$iv":Ljava/lang/Object;
    .end local v7    # "it":Landroidx/compose/runtime/Recomposer$HotReloadable;
    .end local v8    # "$i$a$-fastForEach-Recomposer$Companion$loadStateAndComposeForHotReload$2":I
    if-le v4, v3, :cond_2
