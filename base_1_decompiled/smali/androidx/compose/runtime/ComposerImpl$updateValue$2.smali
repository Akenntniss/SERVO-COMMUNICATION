...
.method public final invoke(Landroidx/compose/runtime/Applier;Landroidx/compose/runtime/SlotWriter;Landroidx/compose/runtime/RememberManager;)V
    .locals 4
    .param p1, "$noName_0"    # Landroidx/compose/runtime/Applier;
    ...
    .line 1592
    iget-object v0, p0, Landroidx/compose/runtime/ComposerImpl$updateValue$2;->this$0:Landroidx/compose/runtime/ComposerImpl;

    invoke-static {v0}, Landroidx/compose/runtime/ComposerImpl;->access$getAbandonSet$p(Landroidx/compose/runtime/ComposerImpl;)Ljava/util/Set;

    move-result-object v0

    iget-object v1, p0, Landroidx/compose/runtime/ComposerImpl$updateValue$2;->$value:Ljava/lang/Object;
    ...
    invoke-interface {p3, v0}, Landroidx/compose/runtime/RememberManager;->remembering(Landroidx/compose/runtime/RememberObserver;)V

    .line 1595
    :cond_0
    iget v0, p0, Landroidx/compose/runtime/ComposerImpl$updateValue$2;->$groupSlotIndex:I

    iget-object v1, p0, Landroidx/compose/runtime/ComposerImpl$updateValue$2;->$value:Ljava/lang/Object;

    invoke-virtual {p2, v0, v1}, Landroidx/compose/runtime/SlotWriter;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v1}, Landroidx/compose/runtime/RememberManager;->forgetting(Landroidx/compose/runtime/RememberObserver;)V
    ...
    .line 1600
    .local v1, "composition":Landroidx/compose/runtime/CompositionImpl;
    if-eqz v1, :cond_2
    ...
    invoke-virtual {v2, v3}, Landroidx/compose/runtime/RecomposeScopeImpl;->setComposition(Landroidx/compose/runtime/CompositionImpl;)V

    .line 1602
    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Landroidx/compose/runtime/CompositionImpl;->setPendingInvalidScopes$runtime_release(Z)V

    .line 1606
    .end local v0    # "previous":Ljava/lang/Object;
    .end local v1    # "composition":Landroidx/compose/runtime/CompositionImpl;
    :cond_2
    :goto_0
    return-void
.end method
