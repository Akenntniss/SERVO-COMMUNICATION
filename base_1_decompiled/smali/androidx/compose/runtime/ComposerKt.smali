...
.method private static final compositionLocalMapOf([Landroidx/compose/runtime/ProvidedValue;Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap;
    ...
    const-string v2, "C(compositionLocalMapOf)P(1):Composer.kt#9igjgp"
    ...
    .line 309
    .local v7, "$i$a$-mutate-ComposerKt$compositionLocalMapOf$1":I
    array-length v8, v0
    ...
    .local v10, "provided":Landroidx/compose/runtime/ProvidedValue;
    add-int/lit8 v9, v9, 0x1

    .line 310
    invoke-virtual {v10}, Landroidx/compose/runtime/ProvidedValue;->getCanOverride()Z

    move-result v11

    if-nez v11, :cond_1

    invoke-virtual {v10}, Landroidx/compose/runtime/ProvidedValue;->getCompositionLocal()Landroidx/compose/runtime/CompositionLocal;

    move-result-object v11

    move-object/from16 v12, p1

    invoke-static {v12, v11}, Landroidx/compose/runtime/ComposerKt;->contains(Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap;Landroidx/compose/runtime/CompositionLocal;)Z
    ...
    :goto_1
    const v11, 0x564dafec

    invoke-interface {v1, v11}, Landroidx/compose/runtime/Composer;->startReplaceableGroup(I)V

    const-string v11, "*312@11340L24"
    ...
    invoke-virtual {v10}, Landroidx/compose/runtime/ProvidedValue;->getValue()Ljava/lang/Object;

    move-result-object v14

    const/16 v15, 0x48

    invoke-virtual {v13, v14, v1, v15}, Landroidx/compose/runtime/CompositionLocal;->provided$runtime_release(Ljava/lang/Object;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    .line 316
    .end local v10    # "provided":Landroidx/compose/runtime/ProvidedValue;
    :cond_2
    move-object/from16 v12, p1

    .line 3461
    .end local v6    # "it":Ljava/util/Map;
    .end local v7    # "$i$a$-mutate-ComposerKt$compositionLocalMapOf$1":I
...
.method private static final firstInRange(Ljava/util/List;II)Landroidx/compose/runtime/Invalidation;
    ...
    .line 3302
    .local v1, "$i$a$-let-ComposerKt$firstInRange$index$1":I
    if-gez v0, :cond_0
    ...
    .line 3303
    .end local v1    # "$i$a$-let-ComposerKt$firstInRange$index$1":I
    .local v0, "index":I
    :cond_0
    invoke-interface {p0}, Ljava/util/List;->size()I
...
.method public static final removeCurrentGroup(Landroidx/compose/runtime/SlotWriter;Landroidx/compose/runtime/RememberManager;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/compose/runtime/RecomposeScopeImpl;->setComposition(Landroidx/compose/runtime/CompositionImpl;)V
...
.method private static final removeRange(Ljava/util/List;II)V
    ...
    .line 3316
    .local v1, "$i$a$-let-ComposerKt$removeRange$index$1":I
    if-gez v0, :cond_0
    ...
    .line 3317
    .end local v1    # "$i$a$-let-ComposerKt$removeRange$index$1":I
    .local v0, "index":I
    :cond_0
    :goto_0
    invoke-interface {p0}, Ljava/util/List;->size()I
