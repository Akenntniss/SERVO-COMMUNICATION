...
.method public retainAll(Ljava/util/Collection;)Z
    ...
    .line 164
    .local v19, "$i$a$-removeIf$runtime_release-SnapshotMapEntrySet$retainAll$1":I
    ...
    .local v20, "entries":Ljava/util/Map;
    ...
    .end local v20    # "entries":Ljava/util/Map;
    .restart local v2    # "entries":Ljava/util/Map;
    :cond_2
    move-object/from16 v20, v2

    .end local v2    # "entries":Ljava/util/Map;
    .restart local v20    # "entries":Ljava/util/Map;
    :goto_2
    const/4 v1, 0x1

    .end local v18    # "it":Ljava/util/Map$Entry;
    .end local v19    # "$i$a$-removeIf$runtime_release-SnapshotMapEntrySet$retainAll$1":I
    :goto_3
    if-eqz v1, :cond_3
    ...
    .local v14, "this_$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    const/4 v15, 0x0
    ...
    .local v16, "result$iv$iv":Ljava/lang/Object;
    move-object v1, v0
    ...
    .local v25, "this_$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    :try_start_2
    ...
    .line 330
    .local v19, "$i$a$-writable-SnapshotStateMap$mutate$1$1$iv$iv":I
    ...
    .end local v19    # "$i$a$-writable-SnapshotStateMap$mutate$1$1$iv$iv":I
    ...
    .end local v19    # "it$iv$iv$iv$iv":I
    nop
    ...
    .restart local v18    # "$i$f$writable":I
    ...
    .end local v25    # "this_$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .end local v27    # "$this$writable$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .end local v19    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .local v3, "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v25    # "this_$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .restart local v27    # "$this$writable$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    goto :goto_4
    ...
    .line 322
    .end local v14    # "this_$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .end local v15    # "$i$f$writable":I
    .end local v16    # "result$iv$iv":Ljava/lang/Object;
    .end local v18    # "$i$f$writable":I
    .end local v19    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v21    # "$i$f$sync":I
    .end local v22    # "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
    ...
    .end local v1    # "result$iv$iv":Ljava/lang/Object;
    .end local v3    # "this_$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .restart local v16    # "result$iv$iv":Ljava/lang/Object;
    .restart local v25    # "this_$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    :goto_5
    nop
