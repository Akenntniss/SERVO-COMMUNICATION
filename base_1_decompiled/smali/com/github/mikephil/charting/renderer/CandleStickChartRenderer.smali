...
.method protected drawDataSet(Landroid/graphics/Canvas;Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;)V
    ...
    .line 208
    iget-object v15, v0, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->mOpenBuffers:[F

    const/high16 v19, 0x3f000000    # 0.5f

    sub-float v22, v8, v19
    ...
    .line 213
    iget-object v15, v0, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->mCloseBuffers:[F
    ...
    .line 239
    iget-object v15, v0, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->mRangeBuffers:[F
...
.method public drawValues(Landroid/graphics/Canvas;)V
    ...
    .line 263
    .local v7, "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;>;"
    const/4 v0, 0x0
    ...
    .line 267
    .local v15, "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;
    invoke-virtual {v6, v15}, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->shouldDrawValues(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)Z

    move-result v0

    if-eqz v0, :cond_7

    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->getEntryCount()I
    ...
    .line 271
    :cond_0
    invoke-virtual {v6, v15}, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->applyValueTextStyle(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)V

    .line 273
    iget-object v0, v6, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->mChart:Lcom/github/mikephil/charting/interfaces/dataprovider/CandleDataProvider;

    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->getAxisDependency()Lcom/github/mikephil/charting/components/YAxis$AxisDependency;
    ...
    .line 282
    .local v10, "yOffset":F
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->getValueFormatter()Lcom/github/mikephil/charting/formatter/ValueFormatter;

    move-result-object v11

    .line 284
    .local v11, "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->getIconsOffset()Lcom/github/mikephil/charting/utils/MPPointF;
    ...
    invoke-interface {v15, v0}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    .line 301
    .local v4, "entry":Lcom/github/mikephil/charting/data/CandleEntry;
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->isDrawValuesEnabled()Z
    ...
    .line 302
    invoke-virtual {v11, v4}, Lcom/github/mikephil/charting/formatter/ValueFormatter;->getCandleLabel(Lcom/github/mikephil/charting/data/CandleEntry;)Ljava/lang/String;
    ...
    invoke-interface {v15, v0}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->getValueTextColor(I)I
    ...
    .end local v4    # "entry":Lcom/github/mikephil/charting/data/CandleEntry;
    .local v19, "entry":Lcom/github/mikephil/charting/data/CandleEntry;
    move/from16 v4, v17
    ...
    .line 301
    .end local v17    # "y":F
    .end local v19    # "entry":Lcom/github/mikephil/charting/data/CandleEntry;
    .restart local v4    # "entry":Lcom/github/mikephil/charting/data/CandleEntry;
    ...
    .restart local v19    # "entry":Lcom/github/mikephil/charting/data/CandleEntry;
    :goto_2
    invoke-virtual/range {v19 .. v19}, Lcom/github/mikephil/charting/data/CandleEntry;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_5

    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;->isDrawIconsEnabled()Z
    ...
    .end local v15    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;
    ...
    .line 322
    .end local v7    # "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/ICandleDataSet;>;"
    .end local v8    # "i":I
    :cond_8
    return-void
.end method
