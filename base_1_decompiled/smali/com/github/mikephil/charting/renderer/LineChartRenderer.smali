...
.method protected drawCircles(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v5, v1}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->isInBoundsRight(F)Z
    ...
    .line 683
    :cond_7
    invoke-virtual {v13, v14}, Lcom/github/mikephil/charting/renderer/LineChartRenderer$DataSetImageCache;->getBitmap(I)Landroid/graphics/Bitmap;
    ...
    .end local v2    # "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;>;"
    .restart local v16    # "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;>;"
    goto :goto_5
...
.method protected drawCubicBezier(Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;)V
    ...
    invoke-virtual {v0, v1, v7}, Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;->set(Lcom/github/mikephil/charting/interfaces/dataprovider/BarLineScatterCandleBubbleDataProvider;Lcom/github/mikephil/charting/interfaces/datasets/IBarLineScatterCandleBubbleDataSet;)V
    ...
    iget-object v12, v6, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mXBounds:Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;
    ...
    invoke-interface {v7, v12}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    invoke-interface {v7, v13}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    .end local v19    # "prevDy":F
    .local v0, "j":I
    .restart local v2    # "prevDy":F
    :goto_0
    ...
    .line 228
    .local v1, "prevPrev":Lcom/github/mikephil/charting/data/Entry;
    move-object v12, v13
    ...
    :cond_1
    invoke-interface {v7, v0}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    .line 232
    invoke-interface {v7, v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    .end local v1    # "prevPrev":Lcom/github/mikephil/charting/data/Entry;
...
.method protected drawHorizontalBezier(Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;)V
    ...
    .line 147
    .local v2, "prev":Lcom/github/mikephil/charting/data/Entry;
    move-object v4, v2

    .line 150
    .local v4, "cur":Lcom/github/mikephil/charting/data/Entry;
    iget-object v5, p0, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->cubicPath:Landroid/graphics/Path;
    ...
    iget-object v6, p0, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mXBounds:Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;
    ...
    .line 168
    .end local v2    # "prev":Lcom/github/mikephil/charting/data/Entry;
    .end local v4    # "cur":Lcom/github/mikephil/charting/data/Entry;
    .end local v5    # "j":I
    :cond_0
    ...
    .line 170
    iget-object v2, p0, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->cubicFillPath:Landroid/graphics/Path;
    ...
    invoke-virtual {v1, v2}, Lcom/github/mikephil/charting/utils/Transformer;->pathValueToPixel(Landroid/graphics/Path;)V

    .line 182
    iget-object v2, p0, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mBitmapCanvas:Landroid/graphics/Canvas;
...
.method protected drawLinear(Landroid/graphics/Canvas;Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;)V
    ...
    invoke-virtual {v9, v15}, Lcom/github/mikephil/charting/utils/Transformer;->pointValuesToPixel([F)V
    ...
    invoke-virtual {v15, v4}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->isInBoundsRight(F)Z
...
.method public drawValues(Landroid/graphics/Canvas;)V
    ...
    .line 533
    .local v15, "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;
    invoke-virtual {v6, v15}, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->shouldDrawValues(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)Z

    move-result v0

    if-eqz v0, :cond_8

    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getEntryCount()I
    ...
    .line 537
    :cond_0
    invoke-virtual {v6, v15}, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->applyValueTextStyle(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)V

    .line 539
    iget-object v0, v6, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mChart:Lcom/github/mikephil/charting/interfaces/dataprovider/LineDataProvider;

    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getAxisDependency()Lcom/github/mikephil/charting/components/YAxis$AxisDependency;
    ...
    .line 547
    .end local v0    # "valOffset":I
    .local v5, "valOffset":I
    :goto_1
    iget-object v0, v6, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mXBounds:Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;

    iget-object v1, v6, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mChart:Lcom/github/mikephil/charting/interfaces/dataprovider/LineDataProvider;

    invoke-virtual {v0, v1, v15}, Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;->set(Lcom/github/mikephil/charting/interfaces/dataprovider/BarLineScatterCandleBubbleDataProvider;Lcom/github/mikephil/charting/interfaces/datasets/IBarLineScatterCandleBubbleDataSet;)V
    ...
    iget v13, v0, Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;->min:I

    iget-object v0, v6, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->mXBounds:Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;

    iget v14, v0, Lcom/github/mikephil/charting/renderer/BarLineScatterCandleBubbleRenderer$XBounds;->max:I
    ...
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getValueFormatter()Lcom/github/mikephil/charting/formatter/ValueFormatter;

    move-result-object v10

    .line 553
    .local v10, "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getIconsOffset()Lcom/github/mikephil/charting/utils/MPPointF;
    ...
    iput v0, v11, Lcom/github/mikephil/charting/utils/MPPointF;->x:F
    ...
    iput v0, v11, Lcom/github/mikephil/charting/utils/MPPointF;->y:F
    ...
    invoke-virtual {v0, v13}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->isInBoundsRight(F)Z
    ...
    invoke-virtual {v0, v13}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->isInBoundsLeft(F)Z
    ...
    invoke-virtual {v0, v14}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->isInBoundsY(F)Z
    ...
    invoke-interface {v15, v0}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;

    move-result-object v4

    .line 570
    .local v4, "entry":Lcom/github/mikephil/charting/data/Entry;
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->isDrawValuesEnabled()Z
    ...
    .line 571
    invoke-virtual {v10, v4}, Lcom/github/mikephil/charting/formatter/ValueFormatter;->getPointLabel(Lcom/github/mikephil/charting/data/Entry;)Ljava/lang/String;

    move-result-object v2

    int-to-float v0, v5

    sub-float v17, v14, v0

    div-int/lit8 v0, v12, 0x2

    invoke-interface {v15, v0}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->getValueTextColor(I)I
    ...
    .local v19, "entry":Lcom/github/mikephil/charting/data/Entry;
    move/from16 v4, v17

    move/from16 v17, v5

    .end local v5    # "valOffset":I
    ...
    .end local v19    # "entry":Lcom/github/mikephil/charting/data/Entry;
    .restart local v4    # "entry":Lcom/github/mikephil/charting/data/Entry;
    .restart local v5    # "valOffset":I
    :cond_4
    move-object/from16 v19, v4
    ...
    .end local v4    # "entry":Lcom/github/mikephil/charting/data/Entry;
    .end local v5    # "valOffset":I
    .restart local v17    # "valOffset":I
    .restart local v19    # "entry":Lcom/github/mikephil/charting/data/Entry;
    :goto_3
    ...
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;->isDrawIconsEnabled()Z
    ...
    .end local v15    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/ILineDataSet;
