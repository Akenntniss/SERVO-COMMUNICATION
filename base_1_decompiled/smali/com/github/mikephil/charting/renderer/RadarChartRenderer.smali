...
.method public drawHighlighted(Landroid/graphics/Canvas;[Lcom/github/mikephil/charting/highlight/Highlight;)V
    ...
    invoke-virtual {v14, v0}, Lcom/github/mikephil/charting/data/RadarData;->getDataSetByIndex(I)Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;
    ...
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->isHighlightEnabled()Z
    ...
    invoke-interface {v4, v0}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    invoke-virtual {v8, v3, v4}, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->isInBoundsX(Lcom/github/mikephil/charting/data/Entry;Lcom/github/mikephil/charting/interfaces/datasets/IBarLineScatterCandleBubbleDataSet;)Z
    ...
    iget-object v1, v8, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->mChart:Lcom/github/mikephil/charting/charts/RadarChart;
    ...
    iget-object v1, v8, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->mAnimator:Lcom/github/mikephil/charting/animation/ChartAnimator;
    ...
    iget-object v2, v8, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->mAnimator:Lcom/github/mikephil/charting/animation/ChartAnimator;
    ...
    .line 326
    invoke-static {v12, v0, v1, v13}, Lcom/github/mikephil/charting/utils/Utils;->getPosition(Lcom/github/mikephil/charting/utils/MPPointF;FFLcom/github/mikephil/charting/utils/MPPointF;)V
    ...
    invoke-virtual {v5, v0, v1}, Lcom/github/mikephil/charting/highlight/Highlight;->setDraw(FF)V
    ...
    invoke-virtual {v8, v2, v0, v1, v4}, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->drawHighlightLines(Landroid/graphics/Canvas;FFLcom/github/mikephil/charting/interfaces/datasets/ILineScatterCandleRadarDataSet;)V

    .line 336
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->isDrawHighlightCircleEnabled()Z
    ...
    .line 340
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getHighlightCircleStrokeColor()I
    ...
    .line 342
    invoke-interface {v4, v7}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getColor(I)I

    move-result v0

    .line 345
    :cond_2
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getHighlightCircleStrokeAlpha()I
    ...
    invoke-static {v0, v1}, Lcom/github/mikephil/charting/utils/ColorTemplate;->colorWithAlpha(II)I
    ...
    .local v18, "strokeColor":I
    :goto_1
    nop

    .line 351
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getHighlightCircleInnerRadius()F

    move-result v7

    .line 352
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getHighlightCircleOuterRadius()F

    move-result v19

    .line 353
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getHighlightCircleFillColor()I

    move-result v20

    .line 355
    invoke-interface {v4}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getHighlightCircleStrokeWidth()F
    ...
    .local v22, "e":Lcom/github/mikephil/charting/data/RadarEntry;
    move v3, v7

    move-object/from16 v23, v4

    .end local v4    # "set":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .local v23, "set":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    move/from16 v4, v19

    move-object/from16 v19, v5

    .end local v5    # "high":Lcom/github/mikephil/charting/highlight/Highlight;
    .local v19, "high":Lcom/github/mikephil/charting/highlight/Highlight;
    move/from16 v5, v20
    ...
    .line 338
    .end local v18    # "strokeColor":I
    .end local v19    # "high":Lcom/github/mikephil/charting/highlight/Highlight;
    .end local v22    # "e":Lcom/github/mikephil/charting/data/RadarEntry;
    .end local v23    # "set":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .restart local v3    # "e":Lcom/github/mikephil/charting/data/RadarEntry;
    .restart local v4    # "set":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .restart local v5    # "high":Lcom/github/mikephil/charting/highlight/Highlight;
    :cond_4
    move-object/from16 v22, v3
    ...
    .end local v4    # "set":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .end local v5    # "high":Lcom/github/mikephil/charting/highlight/Highlight;
    .restart local v19    # "high":Lcom/github/mikephil/charting/highlight/Highlight;
    .restart local v22    # "e":Lcom/github/mikephil/charting/data/RadarEntry;
    .restart local v23    # "set":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    goto :goto_2
...
.method public drawValues(Landroid/graphics/Canvas;)V
    ...
    .line 163
    .local v12, "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    invoke-static {v0, v0}, Lcom/github/mikephil/charting/utils/MPPointF;->getInstance(FF)Lcom/github/mikephil/charting/utils/MPPointF;

    move-result-object v13

    .line 165
    .local v13, "pIcon":Lcom/github/mikephil/charting/utils/MPPointF;
    ...
    invoke-virtual {v0, v15}, Lcom/github/mikephil/charting/data/RadarData;->getDataSetByIndex(I)Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;
    ...
    .line 171
    .local v5, "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    invoke-virtual {v6, v5}, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->shouldDrawValues(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)Z
    ...
    .line 175
    :cond_0
    invoke-virtual {v6, v5}, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->applyValueTextStyle(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)V

    .line 177
    invoke-interface {v5}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getValueFormatter()Lcom/github/mikephil/charting/formatter/ValueFormatter;

    move-result-object v4

    .line 179
    .local v4, "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    invoke-interface {v5}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getIconsOffset()Lcom/github/mikephil/charting/utils/MPPointF;
    ...
    .line 185
    invoke-interface {v5, v2}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    .line 187
    .local v1, "entry":Lcom/github/mikephil/charting/data/RadarEntry;
    nop

    .line 189
    invoke-virtual {v1}, Lcom/github/mikephil/charting/data/RadarEntry;->getY()F
    ...
    iget-object v3, v6, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->mChart:Lcom/github/mikephil/charting/charts/RadarChart;
    ...
    .line 187
    invoke-static {v11, v0, v3, v12}, Lcom/github/mikephil/charting/utils/Utils;->getPosition(Lcom/github/mikephil/charting/utils/MPPointF;FFLcom/github/mikephil/charting/utils/MPPointF;)V

    .line 193
    invoke-interface {v5}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->isDrawValuesEnabled()Z
    ...
    .line 194
    invoke-virtual {v4, v1}, Lcom/github/mikephil/charting/formatter/ValueFormatter;->getRadarLabel(Lcom/github/mikephil/charting/data/RadarEntry;)Ljava/lang/String;
    ...
    invoke-interface {v5, v2}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->getValueTextColor(I)I
    ...
    .end local v1    # "entry":Lcom/github/mikephil/charting/data/RadarEntry;
    .local v20, "entry":Lcom/github/mikephil/charting/data/RadarEntry;
    move-object/from16 v1, p1
    ...
    .local v22, "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    move v3, v15
    ...
    .end local v5    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .local v16, "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    move/from16 v5, v19
    ...
    .end local v20    # "entry":Lcom/github/mikephil/charting/data/RadarEntry;
    .end local v21    # "yoffset":F
    .end local v22    # "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    .restart local v1    # "entry":Lcom/github/mikephil/charting/data/RadarEntry;
    .restart local v2    # "j":I
    .restart local v4    # "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    .restart local v5    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .local v12, "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    .local v14, "yoffset":F
    .local v16, "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    :cond_1
    ...
    .local v12, "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    .local v14, "j":I
    .restart local v15    # "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    .local v16, "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .restart local v20    # "entry":Lcom/github/mikephil/charting/data/RadarEntry;
    .restart local v21    # "yoffset":F
    .restart local v22    # "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    :goto_2
    ...
    invoke-interface/range {v16 .. v16}, Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;->isDrawIconsEnabled()Z
    ...
    .end local v16    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    .end local v17    # "i":I
    .end local v21    # "yoffset":F
    .end local v22    # "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    ...
    .local v12, "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    .local v15, "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    .restart local v16    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IRadarDataSet;
    ...
    .end local v22    # "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    .local v12, "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    .restart local v14    # "yoffset":F
    :cond_4
    move-object/from16 v22, v12

    .line 223
    .end local v12    # "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
    .end local v15    # "i":I
    .restart local v22    # "pOut":Lcom/github/mikephil/charting/utils/MPPointF;
...
.method protected drawWeb(Landroid/graphics/Canvas;)V
    ...
    .end local v3    # "rotationangle":F
    .local v23, "rotationangle":F
    iget-object v3, v0, Lcom/github/mikephil/charting/renderer/RadarChartRenderer;->mWebPaint:Landroid/graphics/Paint;
    ...
    .end local v21    # "sliceangle":F
    .end local v22    # "factor":F
    .end local v23    # "rotationangle":F
    .restart local v1    # "sliceangle":F
    .restart local v2    # "factor":F
    .restart local v3    # "rotationangle":F
    :cond_1
    move/from16 v21, v1
    ...
    .end local v3    # "rotationangle":F
    .end local v12    # "i":I
    .restart local v21    # "sliceangle":F
    .restart local v22    # "factor":F
    .restart local v23    # "rotationangle":F
    add-int/lit8 v11, v11, 0x1
