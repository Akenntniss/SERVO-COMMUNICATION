...
.method protected drawDataSet(Landroid/graphics/Canvas;Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;)V
    ...
    .line 57
    .local v10, "viewPortHandler":Lcom/github/mikephil/charting/utils/ViewPortHandler;
    ...
    .line 62
    .local v13, "renderer":Lcom/github/mikephil/charting/renderer/scatter/IShapeRenderer;
    if-nez v13, :cond_1
...
.method public drawValues(Landroid/graphics/Canvas;)V
    ...
    .line 103
    .local v7, "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;>;"
    const/4 v0, 0x0
    ...
    check-cast v15, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;

    .line 107
    .local v15, "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;
    invoke-virtual {v6, v15}, Lcom/github/mikephil/charting/renderer/ScatterChartRenderer;->shouldDrawValues(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)Z

    move-result v0

    if-eqz v0, :cond_6

    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getEntryCount()I
    ...
    .line 111
    :cond_0
    invoke-virtual {v6, v15}, Lcom/github/mikephil/charting/renderer/ScatterChartRenderer;->applyValueTextStyle(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)V
    ...
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getAxisDependency()Lcom/github/mikephil/charting/components/YAxis$AxisDependency;
    ...
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getScatterShapeSize()F
    ...
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getValueFormatter()Lcom/github/mikephil/charting/formatter/ValueFormatter;

    move-result-object v11

    .line 123
    .local v11, "formatter":Lcom/github/mikephil/charting/formatter/ValueFormatter;
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getIconsOffset()Lcom/github/mikephil/charting/utils/MPPointF;
    ...
    invoke-interface {v15, v0}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;

    move-result-object v14

    .line 139
    .local v14, "entry":Lcom/github/mikephil/charting/data/Entry;
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->isDrawValuesEnabled()Z
    ...
    invoke-interface {v15, v0}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->getValueTextColor(I)I
    ...
    invoke-interface {v15}, Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;->isDrawIconsEnabled()Z
    ...
    invoke-static/range {v16 .. v21}, Lcom/github/mikephil/charting/utils/Utils;->drawImage(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V
    ...
    .end local v15    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;
    :cond_6
    :goto_4
    ...
    .line 160
    .end local v7    # "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/IScatterDataSet;>;"
    .end local v8    # "i":I
    :cond_7
    return-void
.end method
