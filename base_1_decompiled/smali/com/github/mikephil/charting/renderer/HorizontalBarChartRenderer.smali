...
.method protected drawDataSet(Landroid/graphics/Canvas;Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;I)V
    ...
    .local v17, "barData":Lcom/github/mikephil/charting/data/BarData;
    ...
    .line 78
    .end local v15    # "x":F
    .end local v17    # "barData":Lcom/github/mikephil/charting/data/BarData;
    ...
    .end local v9    # "barData":Lcom/github/mikephil/charting/data/BarData;
    .restart local v17    # "barData":Lcom/github/mikephil/charting/data/BarData;
    goto :goto_3
    ...
    .line 117
    iget-object v10, v0, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mRenderPaint:Landroid/graphics/Paint;
    ...
    .line 122
    iget-object v11, v0, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mViewPortHandler:Lcom/github/mikephil/charting/utils/ViewPortHandler;
    ...
    invoke-virtual {v11, v12}, Lcom/github/mikephil/charting/utils/ViewPortHandler;->isInBoundsBottom(F)Z
    ...
    .line 131
    iget-object v11, v0, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mRenderPaint:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mBarBorderPaint:Landroid/graphics/Paint;
...
.method public drawValues(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v6, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mChart:Lcom/github/mikephil/charting/interfaces/dataprovider/BarDataProvider;
    ...
    invoke-virtual {v6, v11}, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->shouldDrawValues(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)Z
    ...
    invoke-virtual {v6, v11}, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->applyValueTextStyle(Lcom/github/mikephil/charting/interfaces/datasets/IDataSet;)V
    ...
    iget-object v2, v6, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mBarBuffers:[Lcom/github/mikephil/charting/buffer/BarBuffer;
    ...
    iput v2, v4, Lcom/github/mikephil/charting/utils/MPPointF;->y:F
    ...
    iget-object v2, v5, Lcom/github/mikephil/charting/buffer/BarBuffer;->buffer:[F
    ...
    .line 198
    .local v20, "val":F
    invoke-virtual {v15, v2}, Lcom/github/mikephil/charting/formatter/ValueFormatter;->getBarLabel(Lcom/github/mikephil/charting/data/BarEntry;)Ljava/lang/String;
    ...
    .local v22, "formattedValue":Ljava/lang/String;
    :cond_4
    add-float v0, v1, v8
    ...
    .local v24, "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    neg-float v4, v0
    ...
    .line 205
    .end local v24    # "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    .restart local v4    # "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    :cond_6
    move-object/from16 v24, v4

    .end local v4    # "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    .restart local v24    # "iconsOffset":Lcom/github/mikephil/charting/utils/MPPointF;
    move/from16 v19, v0
    ...
    .local v29, "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;>;"
    move/from16 v4, v25
    ...
    .local v10, "buffer":Lcom/github/mikephil/charting/buffer/BarBuffer;
    .local v24, "i":I
    move/from16 v5, v26
    ...
    .end local v28    # "j":I
    .end local v29    # "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;>;"
    ...
    .restart local v29    # "dataSets":Ljava/util/List;, "Ljava/util/List<Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;>;"
    :goto_7
    ...
    invoke-static/range {v30 .. v35}, Lcom/github/mikephil/charting/utils/Utils;->drawImage(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V
    ...
    .end local v13    # "y":F
    .end local v20    # "val":F
    .end local v22    # "formattedValue":Ljava/lang/String;
    .end local v23    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .end local v27    # "valueTextWidth":F
    :cond_a
    move/from16 v0, v19
    ...
    iget-object v4, v6, Lcom/github/mikephil/charting/renderer/HorizontalBarChartRenderer;->mAnimator:Lcom/github/mikephil/charting/animation/ChartAnimator;
    ...
    .line 248
    invoke-interface {v11, v5}, Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;->getEntryForIndex(I)Lcom/github/mikephil/charting/data/Entry;
    ...
    .line 267
    .restart local v3    # "vals":[F
    .restart local v4    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .restart local v20    # "color":I
    :cond_f
    invoke-virtual {v15, v4}, Lcom/github/mikephil/charting/formatter/ValueFormatter;->getBarLabel(Lcom/github/mikephil/charting/data/BarEntry;)Ljava/lang/String;
    ...
    .local v23, "formattedValue":Ljava/lang/String;
    add-float v2, v0, v8
    ...
    .end local v23    # "formattedValue":Ljava/lang/String;
    .restart local v2    # "formattedValue":Ljava/lang/String;
    :cond_11
    move-object/from16 v23, v2

    .end local v2    # "formattedValue":Ljava/lang/String;
    .restart local v23    # "formattedValue":Ljava/lang/String;
    move v2, v8

    .line 274
    .end local v22    # "negOffset":F
    .local v2, "negOffset":F
    :goto_e
    if-eqz v12, :cond_12
    ...
    .line 274
    .end local v25    # "vals":[F
    .restart local v3    # "vals":[F
    :cond_12
    move-object/from16 v25, v3

    .end local v3    # "vals":[F
    .restart local v25    # "vals":[F
    move/from16 v21, v1
    ...
    .end local v2    # "negOffset":F
    .restart local v21    # "posOffset":F
    .restart local v22    # "negOffset":F
    :goto_f
    invoke-interface {v11}, Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;->isDrawValuesEnabled()Z
    ...
    add-float v26, v1, v14

    .line 280
    move/from16 v27, v0

    .end local v0    # "valueTextWidth":F
    .restart local v27    # "valueTextWidth":F
    move-object/from16 v0, p0
    ...
    .end local v27    # "valueTextWidth":F
    .end local v28    # "halfTextHeight":F
    .restart local v0    # "valueTextWidth":F
    .restart local v4    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    ...
    .restart local v27    # "valueTextWidth":F
    .restart local v28    # "halfTextHeight":F
    :goto_11
    ...
    .end local v13    # "trans":Lcom/github/mikephil/charting/utils/Transformer;
    .local v2, "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .local v25, "trans":Lcom/github/mikephil/charting/utils/Transformer;
    invoke-virtual {v15, v3, v2}, Lcom/github/mikephil/charting/formatter/ValueFormatter;->getBarStackedLabel(FLcom/github/mikephil/charting/data/BarEntry;)Ljava/lang/String;

    move-result-object v13

    .line 340
    .local v13, "formattedValue":Ljava/lang/String;
    move/from16 v21, v0
    ...
    .end local v2    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .local v30, "entry":Lcom/github/mikephil/charting/data/BarEntry;
    add-float v2, v0, v8
    ...
    .end local v30    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .restart local v2    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    :cond_1d
    move-object/from16 v30, v2

    .end local v2    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .restart local v30    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    move v2, v8
    ...
    .end local v8    # "valueOffsetPlus":F
    .restart local v31    # "valueOffsetPlus":F
    move v8, v1
    ...
    .end local v4    # "k":I
    .end local v5    # "transformed":[F
    .restart local v33    # "transformed":[F
    .restart local v34    # "y":F
    .restart local v35    # "x":F
    .restart local v36    # "val":F
    .restart local v37    # "k":I
    :goto_1b
    invoke-virtual/range {v30 .. v30}, Lcom/github/mikephil/charting/data/BarEntry;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {v38 .. v43}, Lcom/github/mikephil/charting/utils/Utils;->drawImage(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V

    .line 334
    .end local v0    # "icon":Landroid/graphics/drawable/Drawable;
    .end local v13    # "formattedValue":Ljava/lang/String;
    ...
    .end local v8    # "valueOffsetPlus":F
    .end local v13    # "trans":Lcom/github/mikephil/charting/utils/Transformer;
    .end local v23    # "posY":F
    .end local v27    # "negY":F
    .local v25, "trans":Lcom/github/mikephil/charting/utils/Transformer;
    .restart local v30    # "entry":Lcom/github/mikephil/charting/data/BarEntry;
    .restart local v31    # "valueOffsetPlus":F
    :goto_1d
    ...
    .end local v28    # "halfTextHeight":F
    .end local v31    # "valueOffsetPlus":F
    .restart local v8    # "valueOffsetPlus":F
    .restart local v13    # "trans":Lcom/github/mikephil/charting/utils/Transformer;
    .local v14, "halfTextHeight":F
    :cond_2a
    move/from16 v21, v0
    ...
    .end local v10    # "buffer":Lcom/github/mikephil/charting/buffer/BarBuffer;
