...
.method public limitTransAndScale(Landroid/graphics/Matrix;Landroid/graphics/RectF;)V
    ...
    .line 446
    .local v6, "curScaleX":F
    const/4 v7, 0x5

    aget v8, v2, v7

    .line 447
    .local v8, "curTransY":F
    const/4 v9, 0x4

    aget v2, v2, v9

    .line 450
    .local v2, "curScaleY":F
    ...
    .line 469
    iget-object v15, v0, Lcom/github/mikephil/charting/utils/ViewPortHandler;->matrixBuffer:[F

    iget v9, v0, Lcom/github/mikephil/charting/utils/ViewPortHandler;->mTransX:F

    aput v9, v15, v3

    .line 470
    iget v3, v0, Lcom/github/mikephil/charting/utils/ViewPortHandler;->mScaleX:F
    ...
    .line 475
    invoke-virtual {v1, v15}, Landroid/graphics/Matrix;->setValues([F)V
