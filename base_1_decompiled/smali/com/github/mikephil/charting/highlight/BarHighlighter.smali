...
.method public getStackedHighlight(Lcom/github/mikephil/charting/highlight/Highlight;Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;FF)Lcom/github/mikephil/charting/highlight/Highlight;
    ...
    invoke-virtual {p0, v3, v4}, Lcom/github/mikephil/charting/highlight/BarHighlighter;->getClosestStackIndex([Lcom/github/mikephil/charting/highlight/Range;F)I

    move-result v2

    .line 71
    .local v2, "stackIndex":I
    iget-object v5, v0, Lcom/github/mikephil/charting/highlight/BarHighlighter;->mChart:Lcom/github/mikephil/charting/interfaces/dataprovider/BarLineScatterCandleBubbleDataProvider;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/github/mikephil/charting/highlight/Highlight;->getX()F
    ...
    invoke-virtual {v5, v6, v7}, Lcom/github/mikephil/charting/utils/Transformer;->getPixelForValues(FF)Lcom/github/mikephil/charting/utils/MPPointD;

    move-result-object v13

    .line 73
    .local v13, "pixels":Lcom/github/mikephil/charting/utils/MPPointD;
    ...
    iget-wide v8, v13, Lcom/github/mikephil/charting/utils/MPPointD;->x:D

    double-to-float v8, v8

    iget-wide v9, v13, Lcom/github/mikephil/charting/utils/MPPointD;->y:D

    double-to-float v9, v9

    .line 78
    invoke-virtual/range {p1 .. p1}, Lcom/github/mikephil/charting/highlight/Highlight;->getDataSetIndex()I

    move-result v10

    .line 80
    invoke-virtual/range {p1 .. p1}, Lcom/github/mikephil/charting/highlight/Highlight;->getAxis()Lcom/github/mikephil/charting/components/YAxis$AxisDependency;
    ...
    invoke-direct/range {v5 .. v12}, Lcom/github/mikephil/charting/highlight/Highlight;-><init>(FFFFIILcom/github/mikephil/charting/components/YAxis$AxisDependency;)V

    .line 83
    .local v5, "stackedHigh":Lcom/github/mikephil/charting/highlight/Highlight;
    invoke-static {v13}, Lcom/github/mikephil/charting/utils/MPPointD;->recycleInstance(Lcom/github/mikephil/charting/utils/MPPointD;)V
    ...
    .end local v5    # "stackedHigh":Lcom/github/mikephil/charting/highlight/Highlight;
    .end local v13    # "pixels":Lcom/github/mikephil/charting/utils/MPPointD;
    :cond_2
    move/from16 v4, p4

    .line 89
    .end local v3    # "ranges":[Lcom/github/mikephil/charting/highlight/Range;
    return-object v2
.end method
